...
<head>
    ...
    <title name="Longitud">Longitud</title>
</head>
        ...
        <section>
            ...
            <form method="POST" action="">
                ...
                <div class="content-select">
                    <select name="select1">
                        <option value="metros" name="metros">Metros</option>
                        <option value="pulgadas" name="pulgadas">Pulgadas</option>
                        <option value="pies" name="pies">Pies</option>
                        <option value="millas" name="millas">Millas</option>
                    </select>
